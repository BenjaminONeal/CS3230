...
public class TileStack{
	...
	public TileStack(){ //TileStack(boolean nGame)
		...
		for (int i = 0; i < 4; i++){
			...
			stack.add(new WindAndDragonTile('N'));
			stack.add(new WindAndDragonTile('S'));
			stack.add(new WindAndDragonTile('E'));
			stack.add(new WindAndDragonTile('W'));
			stack.add(new WindAndDragonTile('C'));
			stack.add(new WindAndDragonTile('F'));
